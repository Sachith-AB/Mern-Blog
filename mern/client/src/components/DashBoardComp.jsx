        ...
        w-full rounded-md shadow-md'>
            <div className='flex justify-between'>
                <div className=''>
                    ...
                    <HiOutlineUserGroup className='bg-green-500 text-white rounded-full
        ...
        w-full rounded-md shadow-md'>
            <div className='flex justify-between'>
                <div className=''>
                    ...
                    <HiAnnotation className='bg-red-600 text-white rounded-full
                    text-5xl p-3 shadow-lg'/>
        ...
        w-full rounded-md shadow-md'>
            <div className='flex justify-between'>
                <div className=''>
                    ...
                    <HiDocumentText className='bg-blue-600 text-white rounded-full
                    text-5xl p-3 shadow-lg'/>
